...
function ConfirmModal(props) {
    ...
    const onSubmit = async (values) => {
        ...
        await axios.post(`${process.env.REACT_APP_API_ENDPOINT}/api/Users/EmailConfirm`, values)
            .then(res => {
    ...
    const againConfirmCode = async () => {
        ...
        await axios.post(`${process.env.REACT_APP_API_ENDPOINT}/api/Users/AgainEmailConfirm`, data)
