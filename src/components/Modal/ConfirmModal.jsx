...
function ConfirmModal(props) {
    ...
    const onSubmit = async (values) => {
        ...
        await axios.post(`https://api-project-ecommerce.azurewebsites.net/api/Users/EmailConfirm`, values)
            .then(res => {
    ...
    const againConfirmCode = async () => {
        ...
        await axios.post(`https://api-project-ecommerce.azurewebsites.net/api/Users/AgainEmailConfirm`, data)
