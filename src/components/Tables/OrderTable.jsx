...
const OrderTable = (props) => {
    ...
    const acceptHandle = async (id) => {
        await axios.put(`${process.env.REACT_APP_API_ENDPOINT}/api/Orders/accepted/${id}`)
            .then(res => {
    ...
    const rejectHandle = async (id) => {
        ...
        await axios.put(`${process.env.REACT_APP_API_ENDPOINT}/api/Orders/rejected/${id}`)
            .then(res => {
    ...
    const viewHandle = async (id) => {
        dispatch(handleView())
        dispatch(handleOpen())
        await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/Orders/orderitems/${id}`)
