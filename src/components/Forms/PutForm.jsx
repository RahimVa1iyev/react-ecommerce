...
const PutForm = (props) => {
  ...
  useEffect(() => {
    const getProduct = async () => {
      try {
        const response = await axios.get(`https://watch-ecommerce-app.azurewebsites.net/api/${props.controller}/${props.id}`);
  ...
  const onSubmit =  (values) => {
    ...
    const putFetch = async () =>{
      await axios.put(`https://watch-ecommerce-app.azurewebsites.net/api/${props.controller}/${props.id}`,values)
      .then(response => {
