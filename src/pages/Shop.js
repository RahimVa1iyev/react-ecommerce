...
const Shop = () => {
    ...
    const getBrands = async () => {
        await axios.get("https://watch-ecommerce-app.azurewebsites.net/api/Brands/all")
            .then(res => { setProducts(previousState => { return { ...previousState, brands: res.data } }) })

    }

    const getCategories = async () => {
        await axios.get("https://watch-ecommerce-app.azurewebsites.net/api/Categories/all")
            .then(res => { setProducts(previousState => { return { ...previousState, categories: res.data } }) })

    }

    const getGender = async () => {
        await axios.get("https://watch-ecommerce-app.azurewebsites.net/api/Genders/all")
            .then(res => { setProducts(previousState => { return { ...previousState, genders: res.data } }) })
    }

    const getSizes = async () => {
        await axios.get("https://watch-ecommerce-app.azurewebsites.net/api/Sizes/all")
            .then(res => { setProducts(previousState => { return { ...previousState, sizes: res.data } }) })

    }

    const getProducts = async () => {
        await axios.get(`https://watch-ecommerce-app.azurewebsites.net/api/Products/shop`)
            .then(res => {
