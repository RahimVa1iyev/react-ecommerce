...
const getMonthlySale = async () =>{
    await axios.get(`https://api-project-ecommerce.azurewebsites.net/api/Charts/montlysales`)
                                .then(res=> {
...
const getOrderStatusCount = async () =>{
    await axios.get(`https://api-project-ecommerce.azurewebsites.net/api/Charts/count`)
                .then(res=>setOrderCount(res.data))
}

const getUserCount = async () =>{
 var response = await axios.get(`https://api-project-ecommerce.azurewebsites.net/api/Accounts/count`)
   setUserCount(response.data.count);
}

const getIncome = async () => {
  var response = await axios.get(`https://api-project-ecommerce.azurewebsites.net/api/Charts/income`)
