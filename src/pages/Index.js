...
const getMonthlySale = async () =>{
    await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/Charts/montlysales`)
                                .then(res=> {
...
const getOrderStatusCount = async () =>{
    await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/Charts/count`)
                .then(res=>setOrderCount(res.data))
}

const getUserCount = async () =>{
 var response = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/Accounts/count`)
   setUserCount(response.data.count);
}

const getIncome = async () => {
  var response = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/Charts/income`)
