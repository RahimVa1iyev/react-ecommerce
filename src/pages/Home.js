...
const Home = () => {
   ...
   const getRelatedPr = async () => {
      ...
      await axios.get("https://rahimfront-001-site1.anytempurl.com//api/Products/discounted")
