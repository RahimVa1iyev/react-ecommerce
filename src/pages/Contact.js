...
const Contact = () => {
  ...
  const onSubmit = async (values, { resetForm }) => {
    console.log(values);
    if (token) {
      await axios.post(`https://api-project-ecommerce.azurewebsites.net/api/Contacts`, values, {
        headers: {
  ...
  const getInfo = async () => {
    var response = await axios.get('https://api-project-ecommerce.azurewebsites.net/api/Infos/all')
